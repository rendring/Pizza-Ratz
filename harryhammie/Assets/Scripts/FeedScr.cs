...
public class FeedScr : MonoBehaviour
{
   [SerializeField]
    ...
    // 6/4/23: Ren H- for increasing food bar on feed btn press
    ...
    private void TurnOnAndOff(){
        ...
        if(foodEnabled == true){
            Food.SetActive(true);
            foodEnabled = false;
            /* 6/4/23: Ren H- Bar Intergration (Test 2):
            ChangeFood += 10; */
            /* 6/4/23: Ren H- Bar Intergration (Test 1): Error says script is unavailable:
            script.ChangeFood + 1;
            script.NeedController.ChangeFood + 1; */
    ...
    /* 6/4/23: Ren H- Bar Intergration (Test 2): Error stated that ChangeFood already existed/was called:
